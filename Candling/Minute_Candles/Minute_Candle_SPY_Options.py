...
import numpy as np
import pandas as pd
from Minute_NBBO_Candling.Options_Minute_NBBO_Candling import options_NBBO_candle
...
for num in range(len(dates)):
    ...
    os.mkdir("/srv/sqc/Minute_Candle/Options_Data/" + date)

# %%
for ind in range(2120, len(all_files)):
    ...
    output_path = "/srv/sqc/Minute_Candle/Options_Data/" + file_name
    print(ind)
